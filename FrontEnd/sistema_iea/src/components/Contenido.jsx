...
<div className='barra' ></div>
    ...
    <div className='tittle' id='seccion1'> 
    ...
    <strong className='tittlequienessomos'>¿QUIÉNES SOMOS?</strong> 
      ...
      <div className='card'>
        ...
        {/* #4 */}   
        <div className='card'>
          <div className=''><img  className='card-imagen dos r' src={utr}  alt="" /></div>
        ...
        {/* #5 */}   
        <div className='card'>
          <div className=''><img  className='card-imagen dos' src={utm}  alt="" /></div>
          <div className='card-info'>Universidad Tecnológica Metropolitana de Aguascalientes</div>
          <button class="fancy" href="#">
          <span class="top-key"></span>
          <span class="text">Ingresar</span>
          <span class="bottom-key-1"></span>
