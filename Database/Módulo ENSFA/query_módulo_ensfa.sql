create table ENSFA_Carreras (IDCarrera serial primary key not null,
...
create table ENSFA_Tasa_cobertura (IDTC serial primary key not null,
								 Carrera int not null, 
								 constraint carrera foreign key(Carrera)
								 references ensfa_carreras(idcarrera),
								 Periodo int,
								 Incremento_matricula decimal);

create table ENSFA_Eficiencia_IRE (IDEIRE serial primary key not null,
								 Carrera int not null,
								 constraint carrera foreign key(Carrera)
								 references ensfa_carreras(idcarrera),
								 Periodo int,
...
create table ENSFA_Tasa_Puntaje_EGEL (IDTPEGEL serial primary key not null,
									  Carrera int not null, 
									  constraint carrera foreign key(Carrera)
									  references ensfa_carreras(idcarrera),
									  Periodo int, 
...
create table ENSFA_Indice_Servicios (IDIS serial primary key not null,
								 Carrera int not null,
								 constraint carrera foreign key(Carrera)
								 references ensfa_carreras(idcarrera),
								 Periodo int,
...
create table ENSFA_ISEg (IDISEG serial primary key not null,
								 Carrera int not null,
								 constraint carrera foreign key(Carrera)
								 references ensfa_carreras(idcarrera),
								 Periodo int,
...
create table ENSFA_ISEm (IDISEM serial primary key not null,
								 Carrera int not null,
								 constraint carrera foreign key(Carrera)
								 references ensfa_carreras(idcarrera),
								 Periodo int,
...
create table ENSFA_Tasa_Docentes (IDTD serial primary key not null, 
								Carrera int not null,
								constraint carrera foreign key(Carrera)
								references ensfa_carreras(idcarrera),
								Periodo int,
...
create table ENSFA_Indice_PTC (IDIPTC serial primary key not null, 
							 Carrera int not null,
							 constraint carrera foreign key(Carrera)
							 references ensfa_carreras(idcarrera),
							 Periodo int,
...
create table ENSFA_Tasa_PE_ASAT (IDTPEASAT serial primary key not null, 
							 	PE int not null,
...
create table ENSFA_Tasa_PE_Pertinencia (IDTPEP serial primary key not null, 
							 	PE int not null,
							 	constraint PE foreign key(PE)
							 	references ensfa_carreras(idcarrera),
							 	Periodo int,
...
create table ENSFA_Indice_Colocacion (IDIC serial primary key not null, 
							 Carrera int not null,
							 constraint carrera foreign key(Carrera)
							 references ensfa_carreras(idcarrera),
							 Periodo int,
...
create table ENSFA_Tasa_Mov_Alumnos (IDTMA serial primary key not null, 
							 Carrera int not null,
							 constraint carrera foreign key(Carrera)
							 references ensfa_carreras(idcarrera),
							 Periodo int,
...
create table ENSFA_Tasa_Mov_Docentes (IDTMD serial primary key not null, 
							 Carrera int not null,
							 constraint carrera foreign key(Carrera)
							 references ensfa_carreras(idcarrera),
							 Periodo int,
...
create table ENSFA_Tasa_Acreditacion (IDTA serial primary key not null, 
							 Carrera int not null,
							 constraint carrera foreign key(Carrera)
							 references ensfa_carreras(idcarrera),
							 Periodo int,
...
create table ENSFA_Tasa_Puntaje_Ex (IDTPEX serial primary key not null,
									  Carrera int not null, 
									  constraint carrera foreign key(Carrera)
									  references ensfa_carreras(idcarrera),
									  Periodo int, 
