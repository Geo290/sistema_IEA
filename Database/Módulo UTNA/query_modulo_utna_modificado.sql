...
create table UTNA_Tasa_Puntaje_EGETSU (IDTPEGETSU serial primary key not null,
									  Carrera int not null, 
									  constraint carrera foreign key(Carrera)
									  references utna_carreras(idcarrera),
									  Periodo int, 
...
create table UTNA_Tasa_Puntaje_ExTSU (IDTPEXTSU serial primary key not null,
									  Carrera int not null, 
									  constraint carrera foreign key(Carrera)
									  references utna_carreras(idcarrera),
									  Periodo int, 
...
create table UTNA_Tasa_Puntaje_ExL (IDTPEXL serial primary key not null,
									  Carrera int not null, 
									  constraint carrera foreign key(Carrera)
									  references utna_carreras(idcarrera),
									  Periodo int, 
