create table UTC_Carreras (IDCarrera serial primary key not null,
...
create table UTC_Tasa_cobertura (IDTC serial primary key not null,
								 Carrera int not null, 
								 constraint carrera foreign key(Carrera)
								 references utc_carreras(idcarrera),
								 Periodo int,
								 Incremento_matricula decimal);

create table UTC_Eficiencia_IRE (IDEIRE serial primary key not null,
								 Carrera int not null,
								 constraint carrera foreign key(Carrera)
								 references utc_carreras(idcarrera),
								 Periodo int,
...
create table UTC_Tasa_Puntaje_EGETSU (IDTPEGETSU serial primary key not null,
									  Carrera int not null, 
									  constraint carrera foreign key(Carrera)
									  references utc_carreras(idcarrera),
									  Periodo int, 
...
create table UTC_Tasa_Puntaje_EGEL (IDTPEGEL serial primary key not null,
									  Carrera int not null, 
									  constraint carrera foreign key(Carrera)
									  references utc_carreras(idcarrera),
									  Periodo int, 
...
create table UTC_Tasa_Puntaje_ExTSU (IDTPEXTSU serial primary key not null,
									  Carrera int not null, 
									  constraint carrera foreign key(Carrera)
									  references utc_carreras(idcarrera),
									  Periodo int, 
...
create table UTC_Tasa_Puntaje_ExL (IDTPEXL serial primary key not null,
									  Carrera int not null, 
									  constraint carrera foreign key(Carrera)
									  references utc_carreras(idcarrera),
									  Periodo int, 
...
create table UTC_Indice_Servicios (IDIS serial primary key not null,
								 Carrera int not null,
								 constraint carrera foreign key(Carrera)
								 references utc_carreras(idcarrera),
								 Periodo int,
...
create table UTC_ISEg_TSU (IDISEGTSU serial primary key not null,
								 Carrera int not null,
								 constraint carrera foreign key(Carrera)
								 references utc_carreras(idcarrera),
								 Periodo int,
...
create table UTC_ISEg_L (IDISEGL serial primary key not null,
								 Carrera int not null,
								 constraint carrera foreign key(Carrera)
								 references utc_carreras(idcarrera),
								 Periodo int,
...
create table UTC_ISEm_TSU (IDISEMTSU serial primary key not null,
								 Carrera int not null,
								 constraint carrera foreign key(Carrera)
								 references utc_carreras(idcarrera),
								 Periodo int,
...
create table UTC_ISEm_L (IDISEML serial primary key not null,
								 Carrera int not null,
								 constraint carrera foreign key(Carrera)
								 references utc_carreras(idcarrera),
								 Periodo int,
...
create table UTC_Tasa_Docentes (IDTD serial primary key not null, 
								Carrera int not null,
								constraint carrera foreign key(Carrera)
								references utc_carreras(idcarrera),
								Periodo int,
...
create table UTC_Indice_PTC (IDIPTC serial primary key not null, 
							 Carrera int not null,
							 constraint carrera foreign key(Carrera)
							 references utc_carreras(idcarrera),
							 Periodo int,
...
create table UTC_Tasa_PE_ASAT (IDTPEASAT serial primary key not null, 
							 	PE int not null,
...
create table UTC_Tasa_PE_Pertinencia (IDTPEP serial primary key not null, 
							 	PE int not null,
							 	constraint PE foreign key(PE)
							 	references utc_carreras(idcarrera),
							 	Periodo int,
...
create table UTC_Indice_Colocacion (IDIC serial primary key not null, 
							 Carrera int not null,
							 constraint carrera foreign key(Carrera)
							 references utc_carreras(idcarrera),
							 Periodo int,
...
create table UTC_Tasa_Mov_Alumnos (IDTMA serial primary key not null, 
							 Carrera int not null,
							 constraint carrera foreign key(Carrera)
							 references utc_carreras(idcarrera),
							 Periodo int,
...
create table UTC_Tasa_Mov_Docentes (IDTMD serial primary key not null, 
							 Carrera int not null,
							 constraint carrera foreign key(Carrera)
							 references utc_carreras(idcarrera),
							 Periodo int,
...
create table UTC_Tasa_Acreditacion (IDTA serial primary key not null, 
							 Carrera int not null,
							 constraint carrera foreign key(Carrera)
							 references utc_carreras(idcarrera),
							 Periodo int,
